...
size_t Page::get_pid() const { return page_id_; }
string const & Page::get_fname() const { return fname_; }

bool Page::is_unpinned() { return pin_count_ == 0; }
bool Page::is_dirty() { return dirty_; }

void Page::pin() { ++pin_count_; }
void Page::unpin() { pin_count_ = std::max((int)pin_count_ - 1, 0); }
